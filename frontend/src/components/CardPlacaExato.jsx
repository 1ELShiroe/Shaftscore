...
const CardPlacaExato = ({ data, title, type, reason }) => {
          ...
          <ItemCard>
            ...
            <WrapperCard>
              <Confrontation>
                {item.confront
                  ? item.confront
                  : `${item.teamOne} x ${item.teamTwo}`}
              </Confrontation>
              <SuggestionWraper>
                <SuggestionText>Placar Exato:</SuggestionText>
                <Suggestion>
                  <span>{item.placar} </span>
                  <span className="green"> {item.gol}</span>
                </Suggestion>
              </SuggestionWraper>
            </WrapperCard>
          </ItemCard>
