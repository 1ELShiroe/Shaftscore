...
let g = {
  ...
  away: {
    goals: [],
    id: 629,
    img: "https://cdn.footystats.org/img/teams/brazil-ac-goianiense.png",
    name: "Atletico",
    game_week: 38,
  },
  home: {
  ...
  return (
    <>
      ...
      <Content>
        ...
        <div className="content octave_ahorow">
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
        ...
        <div className="content dwoda_ahorow">
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
          <GameVersus champions data={g} />
